{
  ...
  doomEmacs = "~/.emacs.d";
  doomConf = config.lib.file.mkOutOfStoreSymlink "/Users/yoneda/workspace/nix-playground/flake-playground/minimal-darwin/homeConfigurations/emacs/doom.d";
in {
  programs.emacs.enable = true;

  home.file.".doom.d".source = doomConf;
  home.file.".emacs.d".source = nivSources.emacs-doom;
